...
STRAT_HI_WATER = 0.90        # 大盘水位≥90% → 持仓侧强制瘦身
STRAT_HI_WATER_SLOTS = 5     #   高位槽位上限 (批判清单⑦, 变体H实测)
STRAT_STYLE_CAP = 0.35       # 组合级单一RBSA板块暴露上限 (批判清单⑧, 批算页警示)
# 已数据否决、归档封死的执行层方案:
#   MA20破位离场(-73.9pp) / 15%移动止损(-31.6pp) / 提前<60卖(-5.9pp) / 高位禁开仓(恒等冗余)
